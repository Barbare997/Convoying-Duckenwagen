...
class LaneServoingAgent:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.base_speed          = cfg.get('base_speed',          0.32)
        self.curve_speed         = cfg.get('curve_speed',         0.21)
    ...
    def _motor_commands(
        self, steering: float, recovery: bool, is_curve: bool, both_visible: bool,
        allow_curve_boost: bool = True,
    ):
        if recovery:
            return 0.0, 0.0
        ...
        if allow_curve_boost and is_curve and abs(steering) > self.steering_threshold:
            if steering > 0:
                right *= 5
            else:
